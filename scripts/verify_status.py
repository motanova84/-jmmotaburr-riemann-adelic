...
def check_project_status():
    ...
    status["checks"]["lean_formalization"] = (
        "completed" if (os.path.exists("formalization/lean") and os.path.isdir("formalization/lean")) else "failed"
    )
    ...
    main_files = ["README.md", "requirements.txt", "validate_explicit_formula.py", "validate_critical_line.py"]
