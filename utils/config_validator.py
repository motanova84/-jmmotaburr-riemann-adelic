...
def validate_computational_params(max_primes: int, max_zeros: int, integration_t: float) -> Tuple[bool, str]:
    """
...
def validate_config(config: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    # Validate computational parameters
    is_valid, error = validate_computational_params(config["max_primes"], config["max_zeros"], config["integration_t"])
    if not is_valid:
