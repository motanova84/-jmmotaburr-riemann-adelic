...
def main():
    ...
    tests = [
        ...
        ("python3 verify_a4_lemma.py", "Original A4 Lemma Verification", 30),
        # Test 2: Extended GL₁ validation (limited)
        ("python3 gl1_extended_validation.py --max-prime 100 --precision 30", "Extended GL₁(p) Validation (Quick)", 30),
        # Test 3: KSS analysis
        ("python3 kss_analysis.py --precision 30", "Kato-Seiler-Simon Analysis", 60),
