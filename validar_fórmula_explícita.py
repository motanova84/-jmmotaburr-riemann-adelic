"""
🧠 Copilot Prompt:
Crear un flujo de trabajo de GitHub Actions para ejecutar este script al hacer push y almacenar el CSV de salida en /data/.

El script valida una fórmula explícita relacionada con la Hipótesis de Riemann.

Utiliza:
- f1, f2, f3: funciones de test con soporte compacto
- prime_sum(f), A_infty(f), zero_sum(f)
- Comparación entre lados aritméticos vs espectrales.

Añadir utilidades auxiliares si faltan.
"""

import mpmath as mp
import sympy as sp
from utilidades.mellin import truncated_gaussian, mellin_transform
