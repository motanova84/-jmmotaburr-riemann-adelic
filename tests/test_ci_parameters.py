...
def test_parameter_presets_defined():
    ...
    perf_monitor_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "utils", "performance_monitor.py")
...
def test_quick_workflow_uses_quick_test_params():
    ...
    workflow_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), ".github", "workflows", "quick.yml")
...
def test_full_workflow_uses_high_accuracy_params():
    ...
    workflow_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), ".github", "workflows", "full.yml")
...
def test_comprehensive_ci_uses_standard_ci_params():
    ...
    workflow_path = os.path.join(
        os.path.dirname(os.path.dirname(__file__)), ".github", "workflows", "comprehensive-ci.yml"
    )
