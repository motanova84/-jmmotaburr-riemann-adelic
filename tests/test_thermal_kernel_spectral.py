...
class TestThermalKernelSpectral:
    ...
    def test_validation_high_accuracy(self):
        ...
        result = validate_spectral_construction(n_basis=15, t=0.001, max_zeros=5, verbose=False)
    ...
    def test_convergence_with_t(self):
        ...
        for t in t_values:
            result = validate_spectral_construction(n_basis=15, t=t, max_zeros=5, verbose=False)
    ...
    def test_spectrum_matches_odlyzko(self):
        ...
        result = validate_spectral_construction(n_basis=20, t=0.001, max_zeros=10, verbose=False)
    ...
    def test_matrix_size_consistency(self):
        ...
        for n in sizes:
            result = validate_spectral_construction(n_basis=n, t=0.001, max_zeros=3, verbose=False)
    ...
    def test_thermal_parameter_small(self):
        ...
        result = validate_spectral_construction(n_basis=15, t=0.0001, max_zeros=5, verbose=False)  # Very small t
