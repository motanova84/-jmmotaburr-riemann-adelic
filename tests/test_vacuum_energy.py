...
class TestVacuumEnergyCalculator:
    ...
    def test_fractal_term_vanishes_at_pi_powers(self):
        ...
        calc = VacuumEnergyCalculator(alpha=0.0, beta=0.0, gamma=0.0, delta=1.0, Lambda=1.0)  # Disable other terms
    ...
    def test_energy_symmetry(self):
        ...
        calc = VacuumEnergyCalculator(
            alpha=1.0, beta=0.0, gamma=1.0, delta=0.0, Lambda=1.0  # Disable adelic coupling  # Disable fractal term
        )
...
class TestNonCircularDerivation:
    ...
    def test_derive_f0_returns_valid_values(self):
        ...
        R_opt, f0 = derive_f0_noncircular(alpha=1.0, beta=1.0, gamma=0.001, delta=0.5, Lambda=1.0)
    ...
    def test_f0_close_to_target(self):
        ...
        _, f0 = derive_f0_noncircular(alpha=1.0, beta=1.0, gamma=0.001, delta=0.5, Lambda=1.0, target_f0=141.7001)
...
class TestPhysicalInterpretation:
    ...
    def test_casimir_term_dominates_small_R(self):
        ...
        calc = VacuumEnergyCalculator(alpha=1.0, beta=0.1, gamma=0.001, delta=0.1, Lambda=1.0)
    ...
    def test_cosmological_term_dominates_large_R(self):
        ...
        calc = VacuumEnergyCalculator(alpha=1.0, beta=0.1, gamma=1.0, delta=0.1, Lambda=1.0)
