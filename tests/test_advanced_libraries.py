...
class TestNumexprIntegration:
    ...
    def test_complex_expression(self):
        ...
        pi = np.pi
        result_numexpr = ne.evaluate("exp(-x**2 / 2) / sqrt(2*pi)", local_dict={"x": x, "pi": pi})
...
class TestDocumentation:
    ...
    def test_advanced_libraries_readme_exists(self):
        ...
        readme_path = os.path.join(os.path.dirname(__file__), "..", "ADVANCED_LIBRARIES_README.md")
...
class TestWorkflows:
    ...
    def test_performance_benchmark_workflow_exists(self):
        ...
        workflow_path = os.path.join(
            os.path.dirname(__file__), "..", ".github", "workflows", "performance-benchmark.yml"
        )
    ...
    def test_advanced_validation_workflow_exists(self):
        ...
        workflow_path = os.path.join(os.path.dirname(__file__), "..", ".github", "workflows", "advanced-validation.yml")
