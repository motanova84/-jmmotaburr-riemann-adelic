...
class TestCriticalLineChecker(unittest.TestCase):
    ...
    def test_functional_equation_consistency(self):
        ...
        required_keys = [
            ...
            "positive_zeros_analyzed",
            "assumed_negative_counterparts",
            "consistency_score",
        ]
        for key in required_keys:
            self.assertIn(key, result)
    ...
    def test_mathematical_certificate_generation(self):
        ...
        required_keys = [
            ...
            "functional_equation_consistency",
...
class TestCriticalLineFileValidation(unittest.TestCase):
    ...
    def test_file_validation(self):
        ...
        result = validate_critical_line_from_file(self.zeros_file, max_zeros=5, precision=15)
    ...
    def test_partial_file_loading(self):
        ...
        result = validate_critical_line_from_file(self.zeros_file, max_zeros=3, precision=15)  # Load only first 3
...
class TestIntegration(unittest.TestCase):
    ...
    def test_complete_workflow(self):
        ...
        test_zeros = [14.134725142, 21.022039639, 25.010857580, 30.424876126, 32.935061588, 37.586178159]
