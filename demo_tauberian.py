...
def main():
    parser = argparse.ArgumentParser(description="Demo of TAUberian Spectral Computation")
    parser.add_argument("--small", action="store_true", help="Run small/fast demo instead of full validation")
    parser.add_argument("--params", action="store_true", help="Show parameter exploration guide")
